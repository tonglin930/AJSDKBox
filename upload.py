...
spec_path = './AJSDKBox.podspec'
spec_name = 'AJSDKBox.podspec'
specs_name = '263nt-italkbbspecs'
source_specs_url = 'ssh://git@gitlab.263nt.com:2200/italkbbspecs/italkbbspecs.git,https://github.com/CocoaPods/Specs'
...
def find_whatsnew_from_ini(file_path,tag):
    ...
    whats_new = cf.get("%s"%tag,"whats_new")
    if len(whats_new) == 0:
